...
function buildWorkspaceShell(){
  ...
  shell.innerHTML = `
    <div class="market-card">
      <div style="display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap;align-items:flex-start;">
        ...
        <div class="btn-row">
          <button id="workspace-auth-open-btn" class="btn btn-soft" type="button">Auth</button>
  ...
  document.querySelectorAll("#auth-panel, #profile-panel, #preview-pane, #marketplace-panel").forEach(el => {
...
// }
  ...
  q("workspace-auth-open-btn")?.addEventListener("click", () => openModalById("workspace-auth-modal"));
  ...
  q("workspace-new-lesson-btn")?.addEventListener("click", () => {
    ...
    if (window.CreatorWorkspace && typeof window.CreatorWorkspace.openLegacyLessonEditor === "function") return window.CreatorWorkspace.openLegacyLessonEditor();
    if (typeof window.openModal === "function") return window.openModal("editor-modal");
