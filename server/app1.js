...
// const READING_DIR = path.join(ROOT_DIR, "reading")
...
// app.use("/reading", express.static(READING_DIR));
...
// app.get("./game/words/", (req, res) => {
//   res.sendFile(path.join(WORDS_DIR, "words.html"));
// });

// app.get("./game/reading/", (req, res) => {
//   res.sendFile(path.join(READING_DIR, "reading.html"));
// });
